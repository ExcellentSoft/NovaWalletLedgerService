...
public class WalletTransactionRepository(NovaWalletDbContext _dbContext) : IWalletTransactionRepository
{
    ...
    public async Task<(IReadOnlyList<WalletTransaction> Items, int TotalCount)> GetPagedByWalletIdAsync(
        Guid walletId,
        int page,
        int pageSize,
